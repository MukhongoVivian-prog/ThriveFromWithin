...
# NOTE : Added mood to the default AUTH User class
...
# NOTE : Extracted this into a single class 'Material' in core
...
class ChatMessage(models.Model):
    session = models.ForeignKey(TherapistSession, on_delete=models.CASCADE)
